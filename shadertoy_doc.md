...
shadertoy-react
1.1.2 • Public • Published 4 years ago
shadertoy-react 🎨
...
uniform vec4 iDeviceOrientation -- Raw data from device orientation where respectively x: Alpha, y: Beta, z: Gamma and w: window.orientation.
