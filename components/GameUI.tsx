 ...
 * GameUI Component
 *
 * Displays the main game interface elements: score, lives, combo, and the
 * sound toggle. Extracted from the main Game component for better modularity.
 */
 ...
 *
 * Each stat keeps its element id (`lives`, `score`, `combo`) because both
 * engines address these nodes directly via getElementById.
 */
